...
SET DEFINE OFF;
Insert into SYSTEM.CLIENTE (ID_CLIENTE,ID_FACTURAS,ID_COMPRAS) values (100,null,null);
...
Insert into SYSTEM.DIRECCION (ID_DIRECCION,C_P,COLONIA,CALLE,NUM_CALLE) values (939,68285,'San Jacinto Amilpas','Santa Cruz',null);
